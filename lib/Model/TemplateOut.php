 ...
 */
class TemplateOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateOut';
    ...
    */
     ...
     * Gets kind
     *
     * @return \Svix\ApiClient\Model\TransformationTemplateKind
     */
     ...
     * Sets kind
     *
     * @param \Svix\ApiClient\Model\TransformationTemplateKind $kind kind
     *
     * @return self
     */
    ...
    public function setFeatureFlag($feature_flag)
    {
        ...
        if ((mb_strlen($feature_flag) > 256)) {
            throw new \InvalidArgumentException('invalid length for $feature_flag when calling TemplateOut., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^[a-zA-Z0-9\\-_.]+$/", ObjectSerializer::toString($feature_flag)))) {
            throw new \InvalidArgumentException("invalid value for \$feature_flag when calling TemplateOut., must conform to the pattern /^[a-zA-Z0-9\\-_.]+$/.");
        }
