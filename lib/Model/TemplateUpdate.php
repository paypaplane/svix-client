    ...
    */
    ...
    public function setTransformation($transformation)
    {
        ...
        if ((mb_strlen($transformation) > 51200)) {
            throw new \InvalidArgumentException('invalid length for $transformation when calling TemplateUpdate., must be smaller than or equal to 51200.');
        }
        if ((mb_strlen($transformation) < 10)) {
            throw new \InvalidArgumentException('invalid length for $transformation when calling TemplateUpdate., must be bigger than or equal to 10.');
        }
    ...
    public function setFeatureFlag($feature_flag)
    {
        ...
        if ((mb_strlen($feature_flag) > 256)) {
            throw new \InvalidArgumentException('invalid length for $feature_flag when calling TemplateUpdate., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^[a-zA-Z0-9\\-_.]+$/", ObjectSerializer::toString($feature_flag)))) {
            throw new \InvalidArgumentException("invalid value for \$feature_flag when calling TemplateUpdate., must conform to the pattern /^[a-zA-Z0-9\\-_.]+$/.");
        }
