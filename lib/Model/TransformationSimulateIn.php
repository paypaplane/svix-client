...
/**
 * TransformationSimulateIn Class Doc Comment
 *
 * @category Class
 * @package  Svix\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class TransformationSimulateIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransformationSimulateIn';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 51200)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TransformationSimulateIn., must be smaller than or equal to 51200.');
        }
        if ((mb_strlen($code) < 10)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TransformationSimulateIn., must be bigger than or equal to 10.');
        }
    ...
    public function setEventType($event_type)
    {
        ...
        if ((mb_strlen($event_type) > 256)) {
            throw new \InvalidArgumentException('invalid length for $event_type when calling TransformationSimulateIn., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^[a-zA-Z0-9\\-_.]+$/", ObjectSerializer::toString($event_type)))) {
            throw new \InvalidArgumentException("invalid value for \$event_type when calling TransformationSimulateIn., must conform to the pattern /^[a-zA-Z0-9\\-_.]+$/.");
        }
