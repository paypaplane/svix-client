    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $url when calling MessageAttemptOut., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling MessageAttemptOut., must be bigger than or equal to 1.');
        }
