 ...
 */
class TemplateIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplateIn';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('instructions', $data ?? [], '');
    ...
    */
    ...
    public function setTransformation($transformation)
    {
        ...
        if ((mb_strlen($transformation) > 51200)) {
            throw new \InvalidArgumentException('invalid length for $transformation when calling TemplateIn., must be smaller than or equal to 51200.');
        }
        if ((mb_strlen($transformation) < 10)) {
            throw new \InvalidArgumentException('invalid length for $transformation when calling TemplateIn., must be bigger than or equal to 10.');
        }
    ...
    public function setFeatureFlag($feature_flag)
    {
        ...
        if ((mb_strlen($feature_flag) > 256)) {
            throw new \InvalidArgumentException('invalid length for $feature_flag when calling TemplateIn., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^[a-zA-Z0-9\\-_.]+$/", ObjectSerializer::toString($feature_flag)))) {
            throw new \InvalidArgumentException("invalid value for \$feature_flag when calling TemplateIn., must conform to the pattern /^[a-zA-Z0-9\\-_.]+$/.");
        }
